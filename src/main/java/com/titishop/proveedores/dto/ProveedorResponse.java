...
public record ProveedorResponse(
		...
		UUID id,
		@Schema(description = "Razón social.", example = "Distribuidora Lima Norte SAC")
		String razonSocial,
		@Schema(description = "RUC.", example = "20123456789")
		String ruc,
		@Schema(description = "Celular de contacto.", example = "987654321")
		String celular,
		@Schema(description = "Teléfono de contacto.", example = "014567890")
		String telefono,
		@Schema(description = "Correo de contacto.", example = "compras@limanorte.pe")
		String email,
		@Schema(description = "Dirección comercial.", example = "Av. Los Almacenes 321, Independencia")
		String direccion,
		@Schema(description = "Estado del proveedor.", example = "ACTIVO")
		EstadoProveedor estado,
		@Schema(description = "Fecha de creación.", example = "2026-06-01T09:15:00Z")
		Instant creadoEn,
		@Schema(description = "Fecha de última actualización.", example = "2026-06-02T15:10:00Z")
