...
@Schema(name = "ErrorResponse", description = "Estructura estándar de error devuelta por la API.")
public record ErrorResponse(
		...
		int status,
		@Schema(description = "Descripción corta del estado HTTP.", example = "Bad Request")
		String error,
