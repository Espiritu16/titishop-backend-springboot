...
public record ActualizarProductoRequest(
		...
		@Schema(description = "Descripción actualizada del producto.", example = "Leche evaporada entera en lata de 410 gramos.", maxLength = 2000)
		...
		@Schema(description = "Identificador de la categoría relacionada.", example = "0f1e2d3c-4b5a-6789-9012-3456789abcde")
